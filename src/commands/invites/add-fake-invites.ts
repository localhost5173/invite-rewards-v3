...
import updateSmartLeaderboards from "../../utils/leaderboards/updateSmartLeaderboards.ts";
import { addFakeInvitesEmbed } from "../../utils/embeds/invites.ts";
...
export default async function (interaction : ChatInputCommandInteraction) {
  ...
  try {
    ...
    const embed = addFakeInvitesEmbed(targetUser, amount, userInvites);
