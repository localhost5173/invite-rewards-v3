    ...
    options: [
        {
            ...
            options: [
                ...
                {
                    name: "question",
                    description: "Creates a verification system with a question that users have to answer",
                    type: ApplicationCommandOptionType.Subcommand,
                    options: [
                        {
                            name: "channel",
                ...
                {
                    name: "pin",
                    description: "Creates a verification system with a random pin that a user must enter to get verified.",
                    type: ApplicationCommandOptionType.Subcommand,
                    options: [
                        {
                            name: "channel",
...
export async function run({ interaction }) {
    ...
    const command = `${subcommandGroup ? `${subcommandGroup} ` : ""}${subcommand ? subcommand : ""}`;
    switch (command) {
        case "setup simple":
