import { ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, PartialGroupDMChannel, } from "discord.js";
...
export default async function (interaction) {
    ...
    try {
        ...
        const filterGiveaways = (activeOnly) => guildGiveaways.filter((giveaway) => (activeOnly ? !giveaway.ended : giveaway.ended));
        ...
        const createGiveawayEmbed = async (index) => {
        ...
        const updateEmbedMessage = async (interaction, page) => {
            const giveaways = filteredGiveaways();
            let embed;
            ...
            const buttons = new ActionRowBuilder().addComponents(new ButtonBuilder()
                ...
                .setDisabled(giveaways.length === 0 || currentPage === 0), new ButtonBuilder()
                .setCustomId("giveaway-next")
                .setLabel("▶")
                .setStyle(ButtonStyle.Primary)
                .setDisabled(giveaways.length === 0 || currentPage === giveaways.length - 1), new ButtonBuilder()
