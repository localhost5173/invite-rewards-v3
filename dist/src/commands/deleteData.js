...
import { ActionRowBuilder, ApplicationCommandOptionType, ButtonBuilder, ButtonStyle, ComponentType, PartialGroupDMChannel } from "discord.js";
...
export async function run({ interaction }) {
    try {
        ...
        const row = new ActionRowBuilder().addComponents(confirmButton, discardButton);
        await interaction.reply({
            embeds: [
        ...
        const filter = (i) => (i.customId === "confirmDeleteAll" || i.customId === "discardDeleteAll") &&
