import { ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType, PartialGroupDMChannel, } from "discord.js";
...
export async function run({ interaction }) {
    try {
        if (!interaction.guild)
            return;
        const categories = await Embeds.getJson(interaction.guild.id, "help.commands");
        ...
        const generateEmbed = async (page, categoryPage) => {
        ...
        const row = new ActionRowBuilder().addComponents(new ButtonBuilder()
            ...
            .setDisabled(currentPage === 0 && currentCategoryPage === 0), new ButtonBuilder()
            .setCustomId("next")
            ...
            await i.update({
                ...
                components: [
                    new ActionRowBuilder().addComponents(new ButtonBuilder()
                        ...
                        .setDisabled(currentPage === totalPages - 1 &&
                        currentCategoryPage ===
                            Math.ceil(categories[categoryNames[currentPage]].length / 10) -
                                1)),
                ],
            });
        });
